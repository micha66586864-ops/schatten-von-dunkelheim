...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Request fullscreen and lock orientation on first interaction
...
// Prevent context menu on game (except inventory for right-click)
document.addEventListener('contextmenu', (e) => {
    if (e.target.closest('#inventory-slots')) return;
    e.preventDefault();
});
